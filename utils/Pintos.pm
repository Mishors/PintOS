...
sub read_loader {
    my ($name) = @_;
    $name = find_file ("/media/mishors/New Volume/Misho/Engineering/Computer Department 3rd Year/OS/Pintos/Phase 0/pintos/src/threads/build/loader.bin") if !defined $name;
